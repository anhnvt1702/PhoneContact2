...
class ListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val contacts = listOf(
            ItemModel(R.drawable.img6, "Thiên Anh"),
            ItemModel(R.drawable.img5, "Nothing"),
            ItemModel(R.drawable.img4, "Hallo"),
            ItemModel(R.drawable.img3, "Quizzz"),
            ItemModel(R.drawable.img2, "Manchester"),
            ItemModel(R.drawable.img1, "Josh"),
            ItemModel(R.drawable.img, "Tạ 100kg"),
            ItemModel(R.drawable.img2, "Manchester"),
            ItemModel(R.drawable.img5, "Nothing"),
            ItemModel(R.drawable.img4, "Hallo"),
            ItemModel(R.drawable.img3, "Quizzz"),
